      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <a>
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="{{ route('SalesRepController.index') }}"><i class="fa fa-address-card"></i> Sales Representative </a></li>
            <li class=""><a href="{{ route('SalesInvoice.index') }}"><i class="fa fa-clipboard-list"></i> Sales Invoice Decleration </a></li>
            <li class=""><a href="{{ route('ICRDeclaration.index') }}"><i class="fa fa-clipboard-list"></i> ICR Decleration </a></li>
            <li class=""><a href="{{ route('CLCDeclaration.index') }}"><i class="fa fa-clipboard-list"></i> CLC Declaration </a></li>
            <li class=""><a href="{{ route('DRDeclaration.index') }}"><i class="fa fa-clipboard-list"></i> DR Decleration </a></li>
